...
class FastMossHTTPSession:
    ...
    def list_product_authors(
        ...
        *,
        ...
        return self.request_json(
            ...
            referer=self._build_goods_detail_referer(product_id),
    ...
    def get_author_base_info(self, uid: str) -> dict[str, Any]:
        ...
        payload = self.request_json(
            ...
            params={"uid": self._normalize_uid(uid)},
            referer=self._build_author_detail_referer(uid),
            region=self.default_region,
    ...
    def get_author_index(self, uid: str) -> dict[str, Any]:
        ...
        payload = self.request_json(
            "GET",
            "/api/author/v3/detail/authorIndex",
            params={"uid": self._normalize_uid(uid)},
            referer=self._build_author_detail_referer(uid),
            region=self.default_region,
            stage="author.index",
    ...
    def get_author_cargo_summary(self, uid: str) -> dict[str, Any]:
        ...
        payload = self.request_json(
            "GET",
            "/api/author/v3/detail/cargoSummary",
            params={"uid": self._normalize_uid(uid)},
            referer=self._build_author_detail_referer(uid),
            region=self.default_region,
    ...
    def get_author_contact(self, uid: str) -> dict[str, Any]:
        ...
        payload = self.request_json(
            "GET",
            "/api/author/v3/detail/authorContact",
            params={"uid": self._normalize_uid(uid)},
            referer=self._build_author_detail_referer(uid),
            region=self.default_region,
