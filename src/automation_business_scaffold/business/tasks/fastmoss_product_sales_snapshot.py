...
from automation_business_scaffold.business.flows import fetch_fastmoss_product_sales_via_browser
...
class FastMossProductSalesSnapshotTask(BaseWorkflowTask):
    ...
    def build_workflow(self, params: dict[str, Any]):
        ...
        return build_single_step_workflow(
            ...
            action_type="fetch_fastmoss_sales_snapshot",
    ...
    def execute_workflow_step(self, context) -> FrameworkResult:
        ...
        snapshot = fetch_fastmoss_product_sales_via_browser(
            ...
            verify_login=_coerce_bool(context.params.get("verify_fastmoss_login"), default=False),
        )
