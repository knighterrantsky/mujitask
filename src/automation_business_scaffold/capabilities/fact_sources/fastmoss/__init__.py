...
from .shop_fetch_handler import CONTRACT as SHOP_FETCH_CONTRACT, HANDLER_CODE as SHOP_FETCH_HANDLER_CODE
from .video_fetch_handler import CONTRACT as VIDEO_FETCH_CONTRACT, HANDLER_CODE as VIDEO_FETCH_HANDLER_CODE
