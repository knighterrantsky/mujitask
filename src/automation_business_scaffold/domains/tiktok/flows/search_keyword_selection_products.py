...
from automation_business_scaffold.contracts.handler.shared import compact_dict, coerce_mapping, merge_fact_bundles
    ...
    *,
    ...
    recovery_stage = recover_browser_fallback_resume_stage(
        ...
        continuation_candidate_ready=bool(
            _selection_row_browser_resume_candidates(store=store, request_id=request_id)
        ),
...
def _advance_dispatch_selection_row_refresh_jobs(
    *,
    store: RuntimeStore,
    request: Any,
    workflow: WorkflowDefinition,
...
def _advance_refresh_selection_rows(
    *,
    store: RuntimeStore,
    request: Any,
    workflow: WorkflowDefinition,
