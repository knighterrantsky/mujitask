...
def test_deploy_writes_amazon_route_only_to_skill_and_cleans_worker_fallback() -> None:
    ...
    for key in (
        "MUJITASK_FEISHU_TK_SELECTION_TABLE_ID",
        "MUJITASK_FEISHU_TK_SELECTION_VIEW_ID",
        "MUJITASK_FEISHU_TK_COMPETITOR_TABLE_ID",
        "MUJITASK_FEISHU_TK_COMPETITOR_VIEW_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_POOL_TABLE_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_POOL_VIEW_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_MONITORING_TABLE_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_MONITORING_VIEW_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_OUTREACH_TABLE_ID",
        "MUJITASK_FEISHU_TK_INFLUENCER_OUTREACH_VIEW_ID",
        "MUJITASK_FEISHU_TK_HOT_VIDEO_TABLE_ID",
        "MUJITASK_FEISHU_TK_HOT_VIDEO_VIEW_ID",
    ):
        assert f'"{key}=$(quote_env_value' in executor_merge
    for key in (
        "MUJITASK_FEISHU_AMAZON_PRODUCTS_BASE_URL",
        "MUJITASK_FEISHU_AMAZON_PRODUCTS_TABLE_ID",
        "MUJITASK_FEISHU_AMAZON_PRODUCTS_VIEW_ID",
